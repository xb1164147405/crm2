...
public class RedisUtil {
    ...
    public <T> List<T> getListObj(String key,Class<T> clazz){
        ...
        try {
            String listJsonStr =  String.valueOf(get(key));
            lists = JSON.parseArray(listJsonStr,clazz);
        } catch (Exception e) {
            LOG.error("redis工具类getListObj()方法异常 key = {}",key,e);
            return null;
        }
        return lists;
    }
